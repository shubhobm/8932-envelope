function [a Gamma e] = Logistic_ini(Y,X,S1,S2,S3)
[N p] = size(X);
data_parameters.Y = Y;
data_parameters.X = X;
...
[fooM fooU] = Logistic_cov(Y,X,data_parameters.alpha,data_parameters.beta);
data_parameters.Sxw = fooM;
eval1 = F4Logistic(S1.gamma,data_parameters);
...
[fooM fooU] = Logistic_cov(Y,X,data_parameters.alpha,data_parameters.beta);
data_parameters.Sxw = fooM;
eval2 = F4Logistic(S2.gamma,data_parameters);
...
[fooM fooU] = Logistic_cov(Y,X,data_parameters.alpha,data_parameters.beta);
data_parameters.Sxw = fooM;
eval3 = F4Logistic(S3.gamma,data_parameters);
