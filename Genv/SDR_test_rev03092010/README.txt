...
-MAIN:
   ...
   # ./PAPERS: a collection of scripts to reproduce reported results for likelihood-based sufficient dimension reduction.


INSTALLATION:
--------------------------------------------------------------------------------
The LDR package requires installation of the LIGHTSPEED TOOLKIT. This allows for using compilled routines that speed up many computations. See installation details in the LIGHTSPEED FOLDER. If you already have this toolkit installed in your machine, yo do not have to install it again.
